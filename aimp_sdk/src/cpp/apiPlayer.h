...
const int AIMP_PLAYER_PROPID_AUTOSWITCHING_CROSSFADE                    = 11;
const int AIMP_PLAYER_PROPID_AUTOSWITCHING_FADEIN                       = 12;
const int AIMP_PLAYER_PROPID_AUTOSWITCHING_FADEOUT                      = 13;
const int AIMP_PLAYER_PROPID_AUTOSWITCHING_PAUSE_BETWEEN_TRACKS         = 14;
const int AIMP_PLAYER_PROPID_MANUALSWITCHING                            = 20;
const int AIMP_PLAYER_PROPID_MANUALSWITCHING_CROSSFADE                  = 21;
const int AIMP_PLAYER_PROPID_MANUALSWITCHING_FADEIN                     = 22;
const int AIMP_PLAYER_PROPID_MANUALSWITCHING_FADEOUT                    = 23;
