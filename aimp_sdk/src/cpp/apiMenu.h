...
const int AIMP_MENUITEM_PROPID_STYLE                      = 5;
...
const int AIMP_MENUID_PLAYER_STOP_OPTIONS                 = 42;
const int AIMP_MENUID_ML_MISCELLANEOUS                    = 50;
const int AIMP_MENUID_ML_DELETION                         = 51;
const int AIMP_MENUID_ML_MAIN_DB                          = 60;

const int AIMP_MENUID_ML_MAIN_FUNCTIONS                   = 61;
const int AIMP_MENUID_ML_MAIN_OPEN                        = 62;
const int AIMP_MENUID_ML_MAIN_OPTIONS                     = 63;
const int AIMP_MENUID_ML_TABLE_CONTEXT_ADDING             = 70;
const int AIMP_MENUID_ML_TABLE_CONTEXT_FUNCTIONS          = 71;

const int AIMP_MENUID_ML_TABLE_CONTEXT_SENDING            = 72;
const int AIMP_MENUID_ML_TABLE_CONTEXT_DELETION           = 73;
const int AIMP_MENUID_ML_TREE_CONTEXT_FUNCTIONS           = 80;
const int AIMP_MENUID_ML_TREE_CONTEXT_DELETION            = 81;
