...
const int AIMP_FILEINFO_PROPID_CONDUCTOR                    = 33;
const int AIMP_FILEINFO_PROPID_MOOD                         = 34;
const int AIMP_FILEINFO_PROPID_CATALOG                      = 35;
const int AIMP_FILEINFO_PROPID_ISRC                         = 36;

const int AIMP_FILEINFO_PROPID_LYRICIST                     = 37;
const int AIMP_FILEINFO_PROPID_ENCODEDBY                    = 38;
const int AIMP_FILEINFO_PROPID_RATING                       = 39;
...
const int AIMP_FILEINFO_PROPID_STAT_DISPLAYING_MARK         = 22;
